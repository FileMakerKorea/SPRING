...
<div id="mainWrap">
  ...
  <form class="loginForm" id="normalLoginForm" name="normalLoginForm">
		<div class="loginFormInput">
			<input name="id" class="loginId" type="text" placeholder="아이디"/>
			<input name="pass" class="loginPass" type="text" placeholder="비밀번호"/>
			<input type="submit" class="loginSubmit" value="로그인"/>
		</div>
		<div class="line"></div>
		<div class="formInfo">
			<div class="formInfoSpan">아직 회원이 아니시라면&nbsp;&nbsp;&nbsp;<a href="#">회원가입</a></div>
