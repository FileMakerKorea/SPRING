...
public class CenterServiceImpl implements CenterService {
	...
	@Override
	public Map<String, Object> centerList(int pageNum, String type, String keyword) {
		...
		System.out.println(
				"listCount : " + listCount + ", type : " + type + ", keyword : " + keyword + " " + searchOption);

		List<Center> centerList = centerDao.centerList(startRow, PAGE_SIZE, type, keyword);
